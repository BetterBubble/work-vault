...
type: report
permalink: tacticum/00-inbox/rag2-p3-meili-validation
tags:
- rag2
- p3
- query-expand
...
## Связанные
- `00-Inbox/rag2-retrieval-miss-diag` (Meili separatorTokens=[], hybrid-баланс), `00-Inbox/rag2-eval-baseline-v2`.
