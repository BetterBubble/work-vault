...
Точка входа «какие у меня репозитории и направления». Модель: **репозиторий → направление → подпроект** (см. [[memory-protocol]] §7). Taiga-проект указан, ЕСЛИ есть — он опционален.
