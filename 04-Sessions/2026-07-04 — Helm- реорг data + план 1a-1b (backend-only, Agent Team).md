...
type: report
permalink: tacticum/04-sessions/2026-07-04-helm-reorg-data-plan-1a-1b-backend-only-agent-team
tags:
- helm
- control-tower
- data
...
- [process] Agent Team: тимлид + @explorer×2 (Opus, разведка ✅) → далее @implementer в git-worktree + независимый @verifier на живом Postgres. Каноническую память пишет только лид; воркеры — черновики в 00-Inbox + SendMessage. #agent-team
