...
type: note
permalink: tacticum/04-sessions/session-archive/session-state-chronicle-2026-07-17-18
status: archived
updated: 2026-07-18
tags:
- session
...
6. **Support-MCP концепт — финализирован** (отложен, дорабатываем позже): `helm/docs/iva-support-mcp-concept.md`. Процесс оператора (8 шагов), выходной контракт (3 выхода + 8 полей, needs_info), триаж-гейт, репомикс/code_context в диагностику. Разборы: `00-Inbox/support-*-DISCOVERY`.
...
## Ссылки
- memory://tacticum/02-architecture/bot-podderzhka-webhook-rag-1-v-chat-iva-zadeploen
- memory://tacticum/02-architecture/team-lead-playbook
- memory://tacticum/02-architecture/agent-team-design
...
## Ссылки (доп.)
- memory://tacticum/02-architecture/git-deploy-hygiene-helm
...
Полный отчёт: [[rag2-r5-rebuild-and-datamap]] (+ scratchpad r5_datamap.md, сырьё 00-Inbox/explore-r5-changelog-recon-raw).
