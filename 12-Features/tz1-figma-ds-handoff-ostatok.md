...
## Блокеры
- Пункты 1–4 зависят от команд вне нашего контура: пока владельцы не подтвердили приём, движения по
  ним не будет, и это ожидаемо, а не сбой. На 2026-07-26 подтверждений нет.
