...
type: decision
permalink: tacticum/03-decisions/helm-vnedrenie-srezov-v-kod-vertikal-po-sloiam-ticket-otdelnoi-tablitsei
tags:
- helm
- control-tower
- slice
...
Зафиксировано 2026-07-07. Как вливать вертикальные срезы в готовый код Helm (после merge origin/main). Основано на разведке code-scout (`00-Inbox/explore-helm-инвентарь-слоёв-для-инцидент-среза`).
