...
type: decision
permalink: tacticum/03-decisions/adr-helm-pg-iadro-podkliuchenie-k-platformennomu-substratu-graphiti-gateway-knowledge-rag
tags:
- helm
- control-tower
- adr
...
- [reference] Черновик разведки: `00-Inbox/explore-graph-primary-store-feasibility-helm`.
