...
## Связано
[[plan-tz-1-dizain-protsess-figma-kod-sts.4-perenos-form-one-kmp-lead-ds]] · `00-Board/remainder-tz1-to-prod-limit` · `map-existing-vs-gap-sc12` · `map-existing-vs-gap-pr-c-axis1` · `map-sc3-and-remainder`
