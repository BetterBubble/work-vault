...
type: note
permalink: tacticum/02-architecture/rag-2-analyst-mcp-kanon-dizaina-dlia-realizatsii
tags:
- rag2
- mcp
- analyst
...
Канон дизайна «RAG#2 как MCP для аналитиков». Решения приняты 2026-07-15 (с руководителем). Основано на разведке (`00-Inbox/rag2-mcp-discovery.md`), распаковке наброска (`rag2-mcp-design-distill.md`, авторский `docs/iva-analyst-mcp-design.md`), ресёрче (`analyst-docs-research.md`).
