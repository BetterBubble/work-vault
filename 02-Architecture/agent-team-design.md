...
type: note
permalink: tacticum/02-architecture/agent-team-design
---
...
7. Сырые находки — в 00-Inbox/ (черновики); каноническую запись делает только лид.

## Память
Только лид пишет в session-state/03-Decisions. Воркеры — черновики в 00-Inbox/ + SendMessage лиду. Task list эфемерен, vault durable.
