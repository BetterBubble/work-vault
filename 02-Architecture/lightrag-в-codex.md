...
type: note
permalink: tacticum/02-architecture/lightrag-v-codex
tags:
- codex
- lightrag
- graph-rag
...
Решение зафиксировано в [[ADR-0002 — LightRAG (graph-RAG) для ЗУ]] (Proposed, развёртывание одобрено руководителем 2026-07-01). Пересматривает прежнее [[lightrag-overkill-for-zus]] (условие «клиент явно попросит» сработало).
...
## Ключевые ссылки
- Решения: [[ADR-0002 — LightRAG (graph-RAG) для ЗУ]], [[ADR-0001 — Демо-стенд RAG ЗУ (Codex)]]
