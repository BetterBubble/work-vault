...
type: plan
permalink: tacticum/20-architecture/helm-plan-posle-deploia-1a-handoff-1
tags:
- helm
- plan
- handoff
...
**Первым делом:** прочитать эту заметку + [[Helm — деплой 1a на dev-сервер (D1–D4 закрыты)]] + канон `control-tower-v02` (21-Decisions).
...
Связано: [[Helm — деплой 1a на dev-сервер (D1–D4 закрыты)]], [[control-tower-v02 — чеклист выравнивания (канон = спека)]].