---
title: 10-Projects — карта проектов
type: index
status: current
created: 2026-07-18 22:35
updated: 2026-07-18 22:35
permalink: tacticum/10-projects/index-1
tags:
- repos
- projects
- map
...
- **ЗУ / knowledge-base** — Taiga: `cifragen-zus-codex` (#28). Направление LightRAG закрыто (граф проиграл вектору) → в [[91-Archive]].