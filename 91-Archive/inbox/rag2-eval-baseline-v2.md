...
type: report
permalink: tacticum/91-archive/inbox/rag2-eval-baseline-v2-1
tags:
- rag2
- eval
- baseline
...
## Связанные
- Предыдущая заметка: `tacticum/00-Board/rag2-eval-baseline-SUMMARY` (оффлайн route-only, разбор харнесса).