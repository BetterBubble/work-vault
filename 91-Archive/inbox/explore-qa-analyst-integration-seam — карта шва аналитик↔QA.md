...
type: note
permalink: tacticum/00-board/explore-qa-analyst-integration-seam-karta-shva-analitik-qa-1
status: draft
role: explorer
lead: lead-qa
created: 2026-07-23
...
- Память: [[ADR (draft) — Модель взаимодействия профилей- аналитик ↔ QA ↔ разработчик + скоупинг MCP по ролям]] · [[Решение- тест-кейсы пишут аналитики, QA дополняет на ревью (2026-07-23)]] · [[qa-profile-model — опись + мульти-стэк модель QA-лейнов]] · [[Направление- Профили → QA-профиль (iva-role-qa) + AQA-toolkit ИВА]]