...
Приняты после критики пользователя (пересмотр приоритетов из [[Формат постановки аналитика ИВА — FR (Feature Request), канон]] / слои / стратегия). Заземлено фактами через iva-mcp и репо.
